...
<head>
    ...
    <!-- CSS here -->
    <link rel="stylesheet" href="./app/public/client/assets/css/preloader.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/owl.carousel.min.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/animate.min.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/magnific-popup.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/meanmenu.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/animate.min.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/slick.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/bootstrap.min.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/fontawesome-all.min.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/themify-icons.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/nice-select.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/ui-range-slider.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/main.css">
    <link rel="stylesheet" href="./app/public/client/assets/css/style.css">
                ...
                <div class="row align-items-center">
                    <div class="col-xxl-3 col-xl-2 col-lg-2 col-md-4 col-sm-6 col-4">
                        <div class="header-left">
                            <div class="logo pr-55 d-inline-block">
                                <a href="index.html"><img src="./app/public/client/assets/img/logo/LOGO FB.png" alt="#"></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-6 col-xl-8 col-lg-8 d-none d-lg-block">
                        <div class="main-menu p-rel d-flex align-items-center justify-content-center">
                            <nav id="mobile-menu">
                                <ul>
                                    <li ><a style="font-family: 'Archivo';font-size: 16px;" href="index.php">Trang chủ</a>
                        ...
                        <div class="header-right-wrapper d-flex align-items-center justify-content-end">
                            <div class="header-right header-right-2 d-flex align-items-center justify-content-end">
                                ...
                                <div class="header-icon header-icon-2 d-inline-block ml-30">
                                    ...
                                    <?php if(isset($_SESSION['cart'])) $countCart= sizeof($_SESSION['cart']) ;?>
                                    <a href="index.php?url=viewcart"><i class="fal fa-shopping-cart"></i><span><?=$countCart?></span></a>
