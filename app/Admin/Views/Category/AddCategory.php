                            ...
                            <div class="card-box">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="demo-box">
                                            <form method="POST" action="../admin/index.php?act=addCategory" data-parsley-validate novalidate enctype="multipart/form-data">
...
$(document).ready(function (){
    $("#submit_cate").on("click", function(e){
        ...
        if(name == ""){
            ...
            $.ajax({
            url: '../admin/index.php?act=addCategory',
            method: "POST",
            data:{
                name:name,
                status:status,
